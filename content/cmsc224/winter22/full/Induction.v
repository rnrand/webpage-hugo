...
(** **** Exercise: 2 stars, standard, recommended but not required (basic_induction)
...
(** **** Exercise: 2 stars, standard, recommended but not required (add_comm_informal)
...
(** **** Exercise: 3 stars, standard, recommended but not required (mul_comm)
...
(** **** Exercise: 3 stars, standard, recommended but not required (binary_commute)
